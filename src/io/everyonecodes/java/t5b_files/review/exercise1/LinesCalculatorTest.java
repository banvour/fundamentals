...
import io.everyonecodes.java.t5b_files.reflection.exercise1.LinesCalculator;
...
class LinesCalculatorTest {
    ...
    private final io.everyonecodes.java.t5b_files.reflection.exercise1.LinesCalculator calculator = new LinesCalculator();
